        ...
        while True:
            try:
                ...
                if task_status == 'REGISTERED':
                    self._logger.info(f"Model {model_name} registered successfully.")
                    return response
                elif task_status == 'DEPLOYED':
                    self._logger.info(f"Model {model_name} is already deployed.")
                    return response
                else:
